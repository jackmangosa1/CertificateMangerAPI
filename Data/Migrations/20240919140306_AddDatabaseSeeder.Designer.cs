...
namespace CertificateMangerAPI.Migrations
{
    ...
    [Migration("20240919140306_AddDatabaseSeeder")]
    partial class AddDatabaseSeeder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CertificateMangerAPI.Models.CertificateType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1720),
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1721)
                        },
                        new
                        {
                            CertificateTypeId = 2,
                            CertificateTypeName = "OHSAS 18001",
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1723),
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1724)
                        });
                });
            ...
            modelBuilder.Entity("CertificateMangerAPI.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DepartmentId = 1,
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1346),
                            DepartmentName = "HR",
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1362)
                        },
                        new
                        {
                            DepartmentId = 2,
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1364),
                            DepartmentName = "IT",
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1365)
                        });
                });
            ...
            modelBuilder.Entity("CertificateMangerAPI.Models.Participant", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ParticipantId = 1,
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1561),
                            DepartmentId = 1,
                            FirstName = "John",
                            LastName = "Doe",
                            Plant = "Plant A",
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1563)
                        },
                        new
                        {
                            ParticipantId = 2,
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1568),
                            DepartmentId = 2,
                            FirstName = "Jane",
                            LastName = "Smith",
                            Plant = "Plant B",
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1568)
                        });
                });
            ...
            modelBuilder.Entity("CertificateMangerAPI.Models.Supplier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SupplierId = 1,
                            City = "City A",
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1616),
                            Name = "Supplier One",
                            SupplierIndex = 1001,
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1617)
                        },
                        new
                        {
                            SupplierId = 2,
                            City = "City B",
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1620),
                            Name = "Supplier Two",
                            SupplierIndex = 1002,
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1620)
                        });
                });
            ...
            modelBuilder.Entity("CertificateMangerAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1666),
                            Email = "jackmangosa@example.com",
                            FirstName = "Jack",
                            LastName = "Mangosa",
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1668),
                            Username = "jackmangosa"
                        },
                        new
                        {
                            UserId = 2,
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1670),
                            Email = "danmangosa@example.com",
                            FirstName = "Dan",
                            LastName = "Mangosa",
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1671),
                            Username = "danmangosa"
                        },
                        new
                        {
                            UserId = 3,
                            CreatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1673),
                            Email = "cedmangosa@example.com",
                            FirstName = "Ced",
                            LastName = "Mangosa",
                            UpdatedAt = new DateTime(2024, 9, 19, 16, 3, 5, 649, DateTimeKind.Local).AddTicks(1674),
                            Username = "cedmangosa"
                        });
                });
